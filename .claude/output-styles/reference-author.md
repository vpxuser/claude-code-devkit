...
description: Precise, template-driven output style for authoring Claude Code references. Use when writing or editing references/*.md files.
keep-coding-instructions: true
---

# Reference Author Output Style
...
- Every REFERENCE.md starts with `---` YAML frontmatter
...
- Reference instructions are testable: each step names a specific tool and expected outcome
