---
name: skill-author
description: Precise, template-driven output style for authoring Claude Code skills. Use when writing or editing SKILL.md files or any Claude Code configuration.
keep-coding-instructions: true
---

# Skill Author Output Style
...
- Skill instructions are testable: each step names a specific tool and expected outcome
