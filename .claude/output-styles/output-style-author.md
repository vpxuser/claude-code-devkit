...
description: Precise, template-driven output style for authoring Claude Code output styles. Use when writing or editing .claude/output-styles/*.md files.
keep-coding-instructions: true
---

# Output Style Author Output Style
...
- Every OUTPUT-STYLE.md starts with `---` YAML frontmatter
...
- Output style instructions are testable: each step names a specific tool and expected outcome
